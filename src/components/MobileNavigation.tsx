    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] md:hidden">
          {/* Backdrop con desenfoque suave animado */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          {/* Drawer / Menú lateral deslizable animado */}
          <motion.aside
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
            transition={{ type: "spring", damping: 28, stiffness: 280 }}
            className="fixed inset-y-0 right-0 z-[101] flex w-full max-w-[320px] sm:max-w-sm flex-col bg-gradient-to-b from-[#0a1217] via-[#0e1c24] to-[#122530] border-l border-cyan-500/30 text-white shadow-2xl overflow-y-auto"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-border/80 px-4 py-3.5 bg-background/50 backdrop-blur">
              ...
              <button
                ...
                className="flex size-9 items-center justify-center rounded-xl bg-white/10 text-white transition-colors hover:bg-white/20 active:scale-95 cursor-pointer"
              >
                <X className="size-5" />
              </button>
            </div>
            ...
            <motion.div
              ...
              className="m-3.5 rounded-2xl bg-cyan-950/60 border border-cyan-500/30 p-3 shadow-inner"
            >
            ...
            <div className="flex-1 px-3.5 py-2 space-y-1.5">
              ...
              <a
                href="#pedir-acarreo"
                onClick={(e) => handleLinkClick(e, "pedir-acarreo")}
    ...
    >
      <div className="flex items-center justify-around gap-1 max-w-md mx-auto">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center py-1 px-2.5 rounded-xl text-muted-foreground hover:text-white active:scale-95 transition-all text-center min-w-[56px] cursor-pointer"
        >
